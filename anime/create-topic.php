		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form" method="post"  action="includes/create-topic.inc.php">
                    ...
                    <div class="wrap-input2 validate-input" data-validate="Rank is required">
						<input class="input2" type="text" name="rank">
						<span class="focus-input2" data-placeholder="Ranking"></span>
					</div>
